...
public interface People {
    ...
    @RequestWrapper(localName = "readPersonHistorys", targetNamespace = "http://ws.document.introsde/", className = "introsde.document.ws.ReadPersonHistorys")
    @ResponseWrapper(localName = "readPersonHistorysResponse", targetNamespace = "http://ws.document.introsde/", className = "introsde.document.ws.ReadPersonHistorysResponse")
    @Action(input = "http://ws.document.introsde/People/readPersonHistorysRequest", output = "http://ws.document.introsde/People/readPersonHistorysResponse")
    public List<HealthMeasureHistory> readPersonHistorys(
        @WebParam(name = "personId", targetNamespace = "")
        long personId,
